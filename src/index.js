document.addEventListener("DOMContentLoaded", () => {
  ...
  const questions = [
    ...
    new Question(
      "What is the name of the teacher in Ironhack school?",
    ...
    new Question(
      ...
      ["Buddy", "Tom", "Ragnar", "Babush"],
      "Ragnar",
      2
    ),
    new Question(
      "What is the capital of Great Britain?",
      ["Berlin", "London", "Paris", "Kyiv"],
      "London",
      1
    ),
  ...
  /*quiz.shuffleQuestions() {
    for (let i = quizquestion.length - 1; i > 0; i--) {
        ...
        [quizquestion[i], quizquestion[j]] = [quizquestion[j], quizquestion[i]];
    }
}*/
  ...
  function showQuestion() {
    ...
    question.choices.forEach((oneChoice) => {
      const htmlElement = document.createElement("div");
      htmlElement.innerHTML = `<input type="radio" name="choice" value = ${oneChoice}>
    ...
    progressBar.style.width = `10%`; // This value is hardcoded as a placeholder
